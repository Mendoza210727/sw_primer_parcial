    ...
    <div class="grid lg:grid-cols-5 sm:grid-cols-2 mb-4 -mt-4 justify-between">
      ...
      <div class="col-span-2">
        <div class="flex justify-start">
          ...
          <SecondaryButton @click="exportAsCode('cpp')" class="ml-1">C++</SecondaryButton>
        </div>
      </div>
        ...
        <ul class="grid w-full gap-2 md:grid-rows-2">
          <li>
            ...
            <label for="arrow_triangle"
              class="inline-flex items-center justify-center w-full py-2 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-blue-500 peer-checked:text-blue-500 hover:text-gray-600 hover:bg-gray-100 ">
...
// The above code is defining a custom class called "MessageLink" that extends the "go.Link" class in
// the Vue HTML framework. This custom class is used to customize the appearance and behavior of links
// in a diagram.
class MessageLink extends go.Link {
  ...
  // Returns the point at which the link should be created
  ...
  // Returns 0 if pointing to the right and 180 if pointing to the left
...
// Gets the diagram content from Diagram
...
const exportAsCode = async (language) => {
  ...
  let extension = '';
  // This method is used to set the route export extension
  switch (language) {
    case 'java':
...
// Creates and initilizes the diagram editor
