    ...
    <AuthenticatedLayout>
        ...
        <nav class="border-b text-sm flex justify-start -mt-4 mb-3">
            <button class="inline-block px-4 py-2"
                :class="[currentTab === 1 ? 'border-b-2 border-blue-500 text-blue-500 font-semibold' : 'text-gray-700 hover:text-black']"
                @click="changeTab(1)">
                Diagramas
            </button>
            <button class="inline-block px-4 py-2 border-b-2"
                :class="[currentTab === 2 ? 'border-b-2 border-blue-500 text-blue-500 font-semibold' : 'text-gray-700 hover:text-black']"
                @click="changeTab(2)">
                Colaboradores
            </button>
        </nav>
